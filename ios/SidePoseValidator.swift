...
class SidePoseValidator {
    ...
    func isSidewaysPose(_ landmarks: PoseLandmarks, 
    ...
    func areArmsSideways(_ landmarks: PoseLandmarks, 
                        tolerance: Float = 0.2) -> Bool {
        guard let leftShoulder = landmarks[.leftShoulder],
    ...
    func areLegsSideways(_ landmarks: PoseLandmarks, 
                        tolerance: Float = 0.2) -> Bool {
    ...
    func isValidSidePose(_ landmarks: PoseLandmarks) -> Bool {
